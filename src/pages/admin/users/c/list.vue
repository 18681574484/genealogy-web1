...
export default {
    data() {
        return {
            ...
            columns: [
                ...
                { title: "手机号", width: 160, key: "mobilePhone" },
                { title: "昵称", minWidth: 160, key: "nickName" },
                { title: "注册时间", width: 160, key: "datetime" },
                {
                    title: "操作",
                    key: "action",
                    width: 160,
    ...
    methods: {
        ...
        toEdit(e) {
            this.roleSite = [];
            this.api
                .post(this.api.admin.user.base + this.api.admin.user.info, {
                    id: e
                })
                .then(res => {
                    if (res.code == 200) {
