    ...
    <div>
        ...
        <Drawer :mask-closable="false" :title="formData.id ? '修改':'添加'" :width="80" v-model="isedit">
            <Form :model="formData" :label-width="80">
                <FormItem label="标题">
                    <Input :maxlength="45" v-model="formData.newsTitle" placeholder="标题"/>
                </FormItem>
                <FormItem label="预览图">
    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(this.api.adminUrl("industry_info", this.admin.step), {
                        id: e
                    })
                    .then(res => {
                        if (res.code == 200) {
        ...
        remove(index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .get(
                            this.api.adminUrl("industry_del", this.admin.step),
                            {
        ...
        toSubmit() {
            ...
            this.api
                .post(this.api.adminUrl("industry_edit", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
        ...
        toDrft() {
            ...
            this.api
                .post(this.api.adminUrl("industry_drft", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
                            this.$Message.success("修改成功");
