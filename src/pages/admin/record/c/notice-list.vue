    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(this.api.adminUrl("record_info", this.admin.step), {
                        id: e
                    })
                    .then(res => {
                        if (res.code == 200) {
        ...
        remove(index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .get(this.api.adminUrl("record_del", this.admin.step), {
        ...
        toSubmit() {
            ...
            this.api
                .post(this.api.adminUrl("record_edit", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
        ...
        toDrft() {
            ...
            this.api
                .post(this.api.adminUrl("record_drft", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
                            this.$Message.success("修改成功");
