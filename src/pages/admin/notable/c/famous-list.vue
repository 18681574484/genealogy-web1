    ...
    data() {
        return {
            ...
            columns: [
                ...
                { title: "浏览数", key: "visitNum", width: 80 },
    ...
    methods: {
        ...
        toEdit(e) {
            ...
            if (!e) {
                ...
                this.api
                    .get(this.api.adminUrl("famous_info", this.admin.step), {
                        id: e
                    })
                    .then(res => {
                        if (res.code == 200) {
        ...
        remove(index) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.api
                        .get(this.api.adminUrl("famous_del", this.admin.step), {
        ...
        toSubmit() {
            ...
            this.api
                .post(this.api.adminUrl("famous_edit", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
        ...
        toDrft() {
            ...
            this.api
                .post(this.api.adminUrl("famous_drft", this.admin.step), data)
                .then(res => {
                    if (res.code === 200) {
                        if (data.id) {
                            this.$Message.success("修改成功");
