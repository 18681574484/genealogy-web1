...
export default {
    data() {
        return {
            ...
            columns: [
                ...
                { title: "字派所在地", minWidth: 160, key: "ziapiLocation" },
                { title: "祖先名", width: 160, key: "ancestorsName" },
                { title: "浏览数", minWidth: 80, key: "visitNum" },
    ...
    methods: {
        ...
        toSubmit() {
            ...
            this.api
                .post(
                    this.api.adminUrl("culture_zipai_edit", this.admin.step),
                    data
                )
                .then(res => {
                    if (res.code === 200) {
