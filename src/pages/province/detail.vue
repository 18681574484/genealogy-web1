<template>
    <div class="pages">
        <Navbar title="详情">
            <div slot="right">
                <small @click="linkToComments">评论 {{info.commentCount}}</small>
            </div>
        </Navbar>
        <div class="tabbar">
            <van-tabbar fixed>
        ...
        <div class="main" v-if="info.id">
            <div class="h">
                ...
                <div class="tag">
                    <div class="item" v-if="info.updateTime">
                        <span>时间：</span>
                        <span>
                            {{dayjs(
                            info.updateTime.replace("+0000", "Z")
...
export default {
    ...
    methods: {
            ...
            this.api
                ...
                .then(res => {
                    ...
                    if (res.code == 200) {
                        this.info = res.data;
                        document.title =
                            this.info.newsTitle || this.info.personName;
                    }
                });
        },
        linkToComments() {
            this.$router.push(
                "comments?id=" + this.info.id + "&entity=" + this.entity
            );
        },
        onLoad() {
            setTimeout(() => {
        ...
        getList() {
            this.api
                .post(
                    this.api.province.base + this.api.province.comments_list,
                    {
        ...
        sendComment() {
            ...
            this.api
                .post(
                    this.api.province.base + this.api.province.comments_add,
                    {
                        createUser: 0,
        ...
        sendReply() {
            ...
            this.api
                .post(
                    this.api.province.base + this.api.province.comments_feeds,
                    {
