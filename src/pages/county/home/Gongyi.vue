    ...
    <div class="gongyi">
        <div class="list">
            <div class="inner">
                ...
                <div class="b">
                    <div class="grid">
                        <router-link class="hd" to="/c/charity?ct=0">
                            <span class="tit">支出公开栏</span>
                        </router-link>
                    ...
                    <div class="grid">
                        <router-link class="hd" to="/c/charity?ct=1">
                            <span class="tit">收益公开栏</span>
                        </router-link>
        ...
        <div class="persons">
            <div class="inner">
                <div class="h">
                    <router-link class="cn" to="/c/charity?ct=2">捐款名人</router-link>
